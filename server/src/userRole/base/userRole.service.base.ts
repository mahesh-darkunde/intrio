...
export class UserRoleServiceBase {
  ...
  async AdminEmail(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
  async AdminId(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
  async AdminName(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
  async CreateUserRole(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
  async DeleteUserRole(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
  async DesignerId(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
  async GetUserRoleById(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
  async UpdateUserRole(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
  async UserId(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
  async UserName(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
}
